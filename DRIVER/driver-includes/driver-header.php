...
<header class="sticky top-0 z-30 border-b border-gray-200" style="background: linear-gradient(135deg, #2D7A5C 0%, #1F5240 100%);">
    <div class="flex items-center justify-between px-6 py-4">
        <div class="flex items-center gap-4">
            ...
            <h1 class="text-2xl font-bold text-white" id="pageTitle">Contact Support</h1>
        </div>
        ...
        <div class="flex items-center gap-6">
            ...
            <div class="flex items-center gap-3 cursor-pointer hover:bg-white hover:bg-opacity-10 rounded-lg px-3 py-2 transition-all" onclick="toggleUserMenu()">
                <div class="w-10 h-10 bg-white bg-opacity-20 rounded-full flex items-center justify-center text-white font-bold">DV</div>
                <div class="hidden md:block">
                    <div class="text-sm font-semibold text-white">Driver Name</div>
                    <div class="text-xs text-white text-opacity-70">Driver</div>
                </div>
...
<div class="hidden fixed top-20 right-6 w-96 bg-white rounded-lg shadow-2xl border border-gray-200 z-50 max-h-[600px] overflow-hidden" id="notificationsDropdown">
    ...
    <div class="bg-gray-50 px-4 py-3 border-t border-gray-200">
        <a href="/CAPTONES/staff-notifications.php" class="block text-center text-sm font-semibold text-primary-green hover:text-dark-green transition-colors">
...
<div class="hidden fixed top-20 right-6 w-64 bg-white rounded-lg shadow-2xl border border-gray-200 z-50" id="userMenuDropdown">
    <div class="p-4 border-b border-gray-200">
        <div class="flex items-center gap-3">
            <div class="w-12 h-12 bg-gradient-to-br from-primary-green to-dark-green rounded-full flex items-center justify-center text-white font-bold text-lg">DV</div>
            <div>
                <div class="font-semibold text-gray-900">Driver Name</div>
                <div class="text-xs text-gray-500">driver@logistics.com</div>
            </div>
        </div>
    </div>

    <div class="py-2">
        <a href="#" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors"><i class="fas fa-user w-5"></i><span>My Profile</span></a>
        <a href="#" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors"><i class="fas fa-cog w-5"></i><span>Settings</span></a>
        <a href="#" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors"><i class="fas fa-bell w-5"></i><span>Notification Settings</span></a>
        <a href="/CAPTONES/driver-contact.php" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors"><i class="fas fa-life-ring w-5"></i><span>Help & Support</span></a>
    </div>

    <div class="border-t border-gray-200 py-2">
        <a href="#" class="flex items-center gap-3 px-4 py-2.5 text-sm text-red-600 hover:bg-red-50 transition-colors" onclick="confirmLogout()"><i class="fas fa-sign-out-alt w-5"></i><span>Logout</span></a>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    const pageTitles = {
        ...
        'trips-details': 'Assigned Trips',
        'reservation-history': 'My Reservation History',
        'trip-history': 'Feedback History',
