    ...
    <nav class="mt-6 pb-6">
        ...
        <div class="mb-2">
            ...
            <div class="<?php echo in_array($current_page, ['vehicle-registry', 'maintenance-tracker', 'fuel-expense-records', 'maintenance-approvals', 'compliance-licensing', 'predictive-maintenance']) ? '' : 'hidden'; ?> bg-white/5 overflow-hidden transition-all duration-300" id="fleet-submenu">
                <!-- PAGE #1 -->
                <a href="/module_1/vehicle-registry.php" class="nav-item text-white/70 px-5 py-2.5 pl-14 flex items-center gap-3 cursor-pointer transition-all duration-300 border-l-3 border-transparent hover:bg-white/10 hover:text-white <?php echo $current_page === 'vehicle-registry' ? 'bg-white/15 border-l-white text-white' : ''; ?>">
                    <i class="fas fa-car text-sm"></i>
                    <span class="text-sm">Vehicle Registry</span>
                </a>
                
                <!-- PAGE #2 -->
                <a href="/module_1/maintenance-tracker.php" class="nav-item text-white/70 px-5 py-2.5 pl-14 flex items-center gap-3 cursor-pointer transition-all duration-300 border-l-3 border-transparent hover:bg-white/10 hover:text-white <?php echo $current_page === 'maintenance-tracker' ? 'bg-white/15 border-l-white text-white' : ''; ?>">
                    <i class="fas fa-wrench text-sm"></i>
                    <span class="text-sm">Maintenance Tracker</span>
                </a>
                
                <!-- PAGE #3 -->
                <a href="/module_1/fuel-expense-records.php" class="nav-item text-white/70 px-5 py-2.5 pl-14 flex items-center gap-3 cursor-pointer transition-all duration-300 border-l-3 border-transparent hover:bg-white/10 hover:text-white <?php echo $current_page === 'fuel-expense-records' ? 'bg-white/15 border-l-white text-white' : ''; ?>">
                ...
                <!-- PAGE #5 -->
                <a href="/module_1/compliance-licensing.php" class="nav-item text-white/70 px-5 py-2.5 pl-14 flex items-center gap-3 cursor-pointer transition-all duration-300 border-l-3 border-transparent hover:bg-white/10 hover:text-white <?php echo $current_page === 'compliance-licensing' ? 'bg-white/15 border-l-white text-white' : ''; ?>">
        ...
        <!-- Vehicle Reservation & Dispatch System (VRDS) - Module 2 -->
            <div class="mb-2">
                ...
                <div class="<?php echo in_array($current_page, ['dispatch-assignment', 'reservation-management', 'availability-calendar']) ? '' : 'hidden'; ?> bg-white/5 overflow-hidden transition-all duration-300" id="vrds-submenu">
                    <!-- PAGE #7 -->
                    <a href="/module_2/dispatch-assignment.php" class="nav-item text-white/70 px-5 py-2.5 pl-14 flex items-center gap-3 cursor-pointer transition-all duration-300 border-l-3 border-transparent hover:bg-white/10 hover:text-white <?php echo $current_page === 'dispatch-assignment' ? 'bg-white/15 border-l-white text-white' : ''; ?>">
                        <i class="fas fa-clipboard-list text-sm"></i>
                        <span class="text-sm">Dispatch & Assignment</span>
                    </a>
                    
                    <!-- PAGE #8 -->
                    <a href="/module_2/reservation-management.php" class="nav-item text-white/70 px-5 py-2.5 pl-14 flex items-center gap-3 cursor-pointer transition-all duration-300 border-l-3 border-transparent hover:bg-white/10 hover:text-white <?php echo $current_page === 'reservation-management' ? 'bg-white/15 border-l-white text-white' : ''; ?>">
        ...
        <!-- Driver and Trip Performance Monitoring - Module 3 -->
            <div class="mb-2">
                ...
                <div class="<?php echo in_array($current_page, ['behavior-analytics', 'incident-management', 'driver-profiles', 'trip-performance']) ? '' : 'hidden'; ?> bg-white/5 overflow-hidden transition-all duration-300" id="performance-submenu">
                    <!-- PAGE #10 -->
                    <a href="/module_3/behavior-analytics.php" class="nav-item text-white/70 px-5 py-2.5 pl-14 flex items-center gap-3 cursor-pointer transition-all duration-300 border-l-3 border-transparent hover:bg-white/10 hover:text-white <?php echo $current_page === 'behavior-analytics' ? 'bg-white/15 border-l-white text-white' : ''; ?>">
                        <i class="fas fa-chart-line text-sm"></i>
                        <span class="text-sm">Behavior Analytics</span>
                    </a>
                    
                    <!-- PAGE #11 -->
                    <a href="/module_3/incident-management.php" class="nav-item text-white/70 px-5 py-2.5 pl-14 flex items-center gap-3 cursor-pointer transition-all duration-300 border-l-3 border-transparent hover:bg-white/10 hover:text-white <?php echo $current_page === 'incident-management' ? 'bg-white/15 border-l-white text-white' : ''; ?>">
                        <i class="fas fa-exclamation-triangle text-sm"></i>
                        <span class="text-sm">Incident Management</span>
                    </a>
                    
                    <!-- PAGE #12 -->
                    <a href="/module_3/driver-profiles.php" class="nav-item text-white/70 px-5 py-2.5 pl-14 flex items-center gap-3 cursor-pointer transition-all duration-300 border-l-3 border-transparent hover:bg-white/10 hover:text-white <?php echo $current_page === 'driver-profiles' ? 'bg-white/15 border-l-white text-white' : ''; ?>">
                        <i class="fas fa-id-card-alt text-sm"></i>
                        <span class="text-sm">Driver Profiles</span>
                    </a>
                    
                    <!-- PAGE #13 -->
                    <a href="/module_3/trip-performance.php" class="nav-item text-white/70 px-5 py-2.5 pl-14 flex items-center gap-3 cursor-pointer transition-all duration-300 border-l-3 border-transparent hover:bg-white/10 hover:text-white <?php echo $current_page === 'trip-performance' ? 'bg-white/15 border-l-white text-white' : ''; ?>">
        ...
        <div class="mb-2">
            ...
            <div class="<?php echo in_array($current_page, ['transport-cost-optimization']) ? '' : 'hidden'; ?> bg-white/5 overflow-hidden transition-all duration-300" id="reports-submenu">
                <a href="/module_4/transport-cost-optimization.php" class="nav-item text-white/70 px-5 py-2.5 pl-14 flex items-center gap-3 cursor-pointer transition-all duration-300 border-l-3 border-transparent hover:bg-white/10 hover:text-white <?php echo $current_page === 'fleet-reports' ? 'bg-white/15 border-l-white text-white' : ''; ?>">
        ...
        <div class="mt-6 mx-4 mb-4">
            <div class="bg-white bg-opacity-10 rounded-lg p-4 text-center">
                ...
                <button class="w-full mt-3 px-4 py-2 bg-white bg-opacity-20 text-white rounded-md text-sm font-semibold hover:bg-opacity-30 transition-all duration-300 flex items-center justify-center gap-2" onclick="window.location.href='/contact-support.php'">
