...
// Handle POST for new reservation
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $data = [
        ...
        'purpose' => $purpose,
        'notes' => $notes,
        'status' => 'Pending Dispatch' // default status
    ];

    // Call function to save reservation
...
<td class="px-5 py-4 text-sm">
    ...
    <?php endif; ?>
                                ...
                                <td class="px-5 py-4 text-sm">
                                    ...
                                    ?>
<?php 
$status = $reservation['status'] ?? 'Pending Dispatch'; 
...
<div id="newReservationModal" class="hidden fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center">
        ...
        <form id="newReservationForm" onsubmit="saveNewReservation(event)" class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="mb-4">
                    ...
                    <select id="newVehicle" name="vehicle_id" required class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-primary-green focus:border-transparent">
                ...
                <div class="mb-4">
                    ...
                    <select name="driver_id" id="newDriver" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-primary-green focus:border-transparent">
                        <option value="">-- No driver assigned --</option>
                        <?php foreach (getAvailableDrivers() as $driver): ?>
                            <?php if ($driver['status'] === 'Available'): ?>
                            <option value="<?php echo $driver['id']; ?>">
                                <?php echo $driver['name']; ?> - <?php echo $driver['license']; ?>
                            </option>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    </select>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="mb-4">
                    ...
                    <input type="date" id="newDate" name="date" required class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-primary-green focus:border-transparent">
                </div>
                <div class="mb-4">
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Time *</label>
                    <input type="time" id="newTime" name="time" required class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-primary-green focus:border-transparent">
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" id="newDestination" name="destination" required placeholder="e.g., Quezon City Hall" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-primary-green focus:border-transparent">
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="mb-4">
                    ...
                    <select id="newDuration" name="duration" required class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-primary-green focus:border-transparent">
                ...
                <div class="mb-4">
                    ...
                    <select id="newPurpose" name="purpose" required class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-primary-green focus:border-transparent">
            ...
            <div class="mb-4">
                ...
                <textarea id="newNotes" name="notes" placeholder="Additional information..." rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-primary-green focus:border-transparent"></textarea>
            </div>

            <!-- Buttons -->
            <div class="flex gap-3 mt-6 pt-4 border-t border-gray-200">
                <button type="button" onclick="closeNewReservationModal()" class="flex-1 px-4 py-2 bg-gray-200 text-gray-700 rounded-md text-sm font-semibold hover:bg-gray-300 transition-all duration-300">
                    <i class="fas fa-times"></i> Cancel
                </button>
                <button type="submit" class="flex-1 px-4 py-2 bg-primary-green text-white rounded-md text-sm font-semibold hover:bg-dark-green transition-all duration-300">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (newReservationModal) {
        newReservationModal.addEventListener('click', function(e) {
...
function saveNewReservation(event) {
    ...
    const driverId = ''; // No driver assigned yet

    fetch('reservation-management.php', {
        method: 'POST',
