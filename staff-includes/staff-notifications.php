...
<head>
    ...
    <title>Notifications - Logistics Staff</title>
...
?>
<div class="<?= $bgColor ?> border <?= $borderColor ?> rounded-lg p-5 notification-item"
     data-type="<?= $notification['type'] ?>"
     data-read="<?= $notification['read'] ? 'true' : 'false' ?>">

    <div class="flex items-start gap-4">
        <div class="w-12 h-12 <?= $iconColors[$notification['color']] ?> rounded-lg flex items-center justify-center">
