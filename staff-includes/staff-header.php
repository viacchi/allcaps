    ...
    <div class="flex items-center justify-between px-6 py-4">
        ...
        <div class="flex items-center gap-6">
            ...
            <div class="flex items-center gap-3 cursor-pointer hover:bg-white hover:bg-opacity-10 rounded-lg px-3 py-2 transition-all" onclick="toggleUserMenu()">
                <div class="w-10 h-10 bg-white bg-opacity-20 rounded-full flex items-center justify-center text-white font-bold">ST</div>
                <div class="hidden md:block">
                    <div class="text-sm font-semibold text-white">Staff Name</div>
                    <div class="text-xs text-white text-opacity-70">staff</div>
                </div>
...
<div class="hidden fixed top-20 right-6 w-64 bg-white rounded-lg shadow-2xl border border-gray-200 z-50" id="userMenuDropdown">
    <div class="p-4 border-b border-gray-200">
        <div class="flex items-center gap-3">
            <div class="w-12 h-12 bg-gradient-to-br from-primary-green to-dark-green rounded-full flex items-center justify-center text-white font-bold text-lg">ST</div>
            <div>
                <div class="font-semibold text-gray-900">Staff Name</div>
                <div class="text-xs text-gray-500">staff@logistics.com</div>
            </div>
        </div>
    </div>
    ...
    <div class="py-2">
        ...
        <a href="/CAPTONES/staff-contact.php" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors"><i class="fas fa-life-ring w-5"></i><span>Help & Support</span></a>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    const pageTitles = {
        ...
        'fuel-tracking': 'Fuel, Mileage & Expense Tracking',
        'trip-logs': 'Trip Logs',
